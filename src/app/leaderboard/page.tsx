    ...
    <div className="flex items-center justify-center min-h-screen ">
      <div className="border-2 border-white w-[840px] h-[280px] flex items-center justify-center">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-center">
            <h2 className="text-white text-4xl font-bold">1. Jarvin</h2>
            <h2 className="text-white text-4xl font-bold">2. Jarvin</h2>
            <h2 className="text-white text-4xl font-bold">3. Jarvin</h2>
          </div>
        </div>
      </div>
    </div>
